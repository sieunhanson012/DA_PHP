        ...
        <div class="panel-body">
            <form action="">
                ...
                <div class="form-group">
                    ...
                    <input type="email" class="form-control" id="_tenDangNhap" name="txtTenDangNhap"
                           placeholder="Tên đăng nhập" value="<?= $data["ten_dang_nhap"]; ?> " disabled>
                </div>
                <div class="form-group">
                    <label for="_email">Email</label>
                    <input type="text" class="form-control" id="_email" name="txtEmail" placeholder="Email"
                           value="<?= $data["email"]; ?> " disabled>
                </div>
                <div class="form-group">
                    <label for="_hoTen">Họ tên</label>
                    <input type="text" class="form-control" id="_hoTen" name="txtHoTen" placeholder="text"
                           value="<?= $data["ho_ten"]; ?> " required>
                </div>
                <div class="form-group">
                    ...
                    <input type="password" class="form-control" id="_matKhau" name="txtMatKhau" placeholder="Mật khẩu"
                           value="<?= $data["mat_khau"]; ?>" required>
                </div>
                <div class="form-group">
                    <label for="_soDienThoai">Số điện thoại</label>
                    <input type="text" class="form-control" id="_soDienThoai" name="txtSoDienThoai"
                           placeholder="Số điện thoại" value="<?= $data["so_dien_thoai"]; ?>" required>
                </div>
                <div class="form-group">
                    <label for="_NgayTao">Ngày tạo</label>
                    <input type="date" class="form-control" id="_NgayTao" name="txtNgayTao"
                           value="<?= $data["ngay_tao"]; ?>" disabled>
                </div>
                <div class="form-group">
                    <label for="_NgayDangNhapCuoi">Lần đăng nhập cuối</label>
                    <input type="date" class="form-control" id="_NgayDangNhapCuoi" name="txtNgayDangNhapCuoi"
                           value="<?= $data["lan_dang_nhap_cuoi"]; ?>" disabled>
                </div>
                <div class="form-group">
