            ...
            <div class="panel-heading">
                <form action="handle_php/h_add_qc.php" id="frmThemQC" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="input-group image-preview">
                            ...
                            <span class="input-group-btn">
                                ...
                                <div class="btn btn-default image-preview-input">
                                    ...
                                    <input type="file" accept="image/png, image/jpeg, image/gif" value="" name="txtHinhAnh" />
                                    <!-- rename it -->
                                </div>
                            </span>
                        </div>
                    ...
                    <button class="btn btn-primary">
                        <i class="fa fa-save"></i> Lưu quảng cáo</button>
                </form>
            </div>
                    ...
                    <table class="table table-hover" style="text-align:center">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <label class="switch">
                                        <input type="checkbox" <?=($rows[ "trang_thai"]==1 ) ? "checked" : ""?> id="chkTrangThaiQC<?=$rows["ma_quang_cao"]?>" onchange=trangThaiQC(<?=$rows["ma_quang_cao"]?>) >
