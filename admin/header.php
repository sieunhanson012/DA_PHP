        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="empty.html">
                            <i class="fa fa-fw fa-truck"></i>Nhập hàng</a>
                    </li>
                    <li>
                        <a href="#">
                            <i class="fa fa-sitemap"></i> Bảng dữ liệu
                            <span class="fa arrow"></span>
                        </a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="index.php?page=tai-khoan">Tài khoản</a>
                            </li>
                            <li>
                                <a href="index.php?page=san-pham">Sản phẩm</a>
                            </li>
                            <li>
                                <a href="index.php?page=hang-san-xuat">Hãng sản xuất</a>
                            </li>
                            <li>
